...
<body>
    ...
    <div class="pageShell beheer-page">
        <div class="pageCard">
            <h1 class="pageTitle">Deelnemers</h1>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php foreach ($players as $index => $player): ?>
                                ...
                                ?>
                                <tr>
                                    <td><a href="../speler_detail.php?id=<?= $player['id'] ?>" style="color: inherit; text-decoration: none; cursor: pointer; border-bottom: 2px solid #007bff;"><?= htmlspecialchars($player['naam']) ?></a></td>
